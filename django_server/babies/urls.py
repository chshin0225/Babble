...
urlpatterns = [
    ...
    path('measurements/weight/', views.WeightListView.as_view()),
    path('measurements/height/', views.HeightListView.as_view()),
    path('measurements/head/', views.HeadListView.as_view()),
